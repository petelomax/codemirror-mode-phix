// CodeMirror Mode Phix, copyright (c) by Marijn Haverbeke, Ian Walter, and
// others. Distributed under an MIT license: http://codemirror.net/LICENSE.
import CodeMirror from 'codemirror'

CodeMirror.defineMode('phix', config => {
  ...
  return {
    ...
    //  with by hand above, these things simply don't entirely work:
    blockCommentStart: "/*",
    blockCommentEnd: "*/",
    lineComment: "--"
  };
